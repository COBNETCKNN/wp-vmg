...
<div class="landingpage__hero h-5/6 relative">
    <div class="container mx-auto">
        ...
        <div class="grid grid-cols-2 gap-4 my-16">
            ...
            <div class="landingpage__content">
                <h1 class="text-white text-6xl font-medium"><?php the_title(); ?></h1>
            ...
            <!-- FORM AREA -->
            <div class="landingpage__form ml-20">
                <h2 class="text-white text-6xl font-medium mb-14"><?php echo $landingPageButtonText; ?></h2>
                <?php            
...
<div class="container mx-auto">
    <div class="grid grid-cols-2 gap-4 my-10">
        <!-- CONTENT AREA -->
        <div class="">
            <h2 class="text-servicetitle text-6xl font-medium"><?php echo $landingPageAboutTitle ?></h2>
...
?>
    ...
    <div class="bg-gray-200 py-20">
        <div class="container mx-auto">
            <div class="grid grid-cols-2 gap-14">
                ...
                <!-- CONTENT -->
                <div class="">
                    <h2 class="text-servicetitle text-6xl font-medium"><?php echo $ourProcessTitle ?></h2>
    ...
    <div class="bg-white py-20">
        <div class="container mx-auto">
            <h2 class="text-servicetitle text-6xl font-medium text-center">Our Process</h2>
            <img class="landingpage_ourprocess__image mx-auto my-20" src="<?php echo get_template_directory_uri() . '/images/ourprocess.jpg'; ?>" alt="">
        </div>
    </div>
    ...
    <div class="bg-white pt-10 pb-20">
        <div class="container mx-auto">
            <h2 class="text-servicetitle text-6xl font-medium text-center mb-10"><?php the_title(); ?></h2>
            <?php     
