...
<footer id="footer" class="bg-footer pt-14 lg:pt-24 pb-14 font-dmsans">
    <div class="container mx-auto">
        <div class="flex justify-between">
            ...
            <div class="flex justify-start">
                ...
                <!-- MAIN MENU SECTION -->
                <div class="hidden lg:block flex my-auto ml-28 font-dmsans text-gray-300 font-light">
            ...
            <div class="flex justify-center">
                ...
                while( have_rows('social_media_icons_and_links') ) : the_row(); ?>
                    ...
                    <img class="h-7 w-7 lg:h-9 lg:w-9 mx-2"src="<?php echo get_sub_field('social_media_icon');?>" alt="">
                    </a>
        ...
        <div class="flex justify-between mt-10">
            <div class="">
                <p class="text-center lg:text-left text-gray-400 text-base lg:text-lg"><?php echo bloginfo('name'); ?> @<?php echo date("Y"); ?>.  All rights reserved.</p>
            </div>
